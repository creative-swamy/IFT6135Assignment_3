...
class Descr():
    def __init__(self, hidden_size, mini_batch, learning_rate, num_epochs, print_interval):
        ...
        self.optimizer = optim.Adam(self.Network.parameters(), lr=self.learning_rate, betas=[0.9, 0.99])
...
estimate = f1_est # estimate the density of distribution4 (on xx) using the discriminator; 
